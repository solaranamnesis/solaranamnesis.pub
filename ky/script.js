      ...
      if (t && t.length > 0) {
        ...
        function l() {
          ...
          n(
            t.filter((t) => {
              const n =
                  "Тилди тандаңыз" === e || t.languages.includes(e),
                s = "Жылды тандаңыз" === a || t.year.includes(a),
                o = "Теманы тандаңыз" === l || t.subjects.includes(l),
                h =
                  "Коллекцияны тандаңыз" === q ||
                  t.collections.includes(q),
                r = "Авторду тандаңыз" === c || t.author.includes(c);
              return n && s && o && r && h;
            }),
          );
        }
