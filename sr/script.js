    ...
    .then((t) => {
      if (t && t.length > 0) {
        ...
        function l() {
          ...
          n(
            t.filter((t) => {
              const n = "Изабери Језик" === e || t.languages.includes(e),
                s = "Изабери Годину" === a || t.year.includes(a),
                o = "Изабери Тему" === l || t.subjects.includes(l),
                h = "Изабери Колекцију" === q || t.collections.includes(q),
                r = "Изабери Аутора" === c || t.author.includes(c);
              return n && s && o && r && h;
            }),
          );
        }
