    ...
    .then((t) => {
      if (t && t.length > 0) {
        ...
        function l() {
          ...
          n(
            t.filter((t) => {
              const n = "ژبه وټاکئ" === e || t.languages.includes(e),
                s = "کال وټاکئ" === a || t.year.includes(a),
                o = "موضوع وټاکئ" === l || t.subjects.includes(l),
                h = "مجموعه وټاکئ" === q || t.collections.includes(q),
                r = "لیکوال وټاکئ" === c || t.author.includes(c);
              return n && s && o && r && h;
            }),
          );
        }
