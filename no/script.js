    ...
    .then((t) => {
      if (t && t.length > 0) {
        ...
        function l() {
          ...
          n(
            t.filter((t) => {
              const n = "Velg språk" === e || t.languages.includes(e),
                s = "Velg år" === a || t.year.includes(a),
                o = "Velg emne" === l || t.subjects.includes(l),
                h = "Velg samling" === q || t.collections.includes(q),
                r = "Velg forfatter" === c || t.author.includes(c);
              return n && s && o && r && h;
            }),
          );
        }
