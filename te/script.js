    ...
    .then((t) => {
      if (t && t.length > 0) {
        ...
        function l() {
          ...
          n(
            t.filter((t) => {
              const n = "భాషను ఎంచుకోండి" === e || t.languages.includes(e),
                s = "సంవత్సరాన్ని ఎంచుకోండి" === a || t.year.includes(a),
                o = "విషయాన్ని ఎంచుకోండి" === l || t.subjects.includes(l),
                h = "సేకరణను ఎంచుకోండి" === q || t.collections.includes(q),
                r = "రచయితను ఎంచుకోండి" === c || t.author.includes(c);
              return n && s && o && r && h;
            }),
          );
        }
