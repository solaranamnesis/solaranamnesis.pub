    ...
    .then((t) => {
      if (t && t.length > 0) {
        ...
        function l() {
          ...
          n(
            t.filter((t) => {
              const n = "Vælg Sprog" === e || t.languages.includes(e),
                s = "Vælg År" === a || t.year.includes(a),
                o = "Vælg Emne" === l || t.subjects.includes(l),
                h = "Vælg Samling" === q || t.collections.includes(q),
                r = "Vælg Forfatter" === c || t.author.includes(c);
              return n && s && o && r && h;
            }),
          );
        }
