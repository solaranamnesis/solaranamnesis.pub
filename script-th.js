function renderBooks() {
  ...
  e.innerHTML = "";
    fetch("books-th.json").then((t => t.json())).then((t => {
    if (t && t.length > 0) {
    loadingIndicator.style.display = "none";
        ...
        function l() {
            ...
            n(t.filter((t => {
                const n = "เลือกภาษา" === e || t.languages.includes(e),
                    s = "เลือกปี" === a || t.year.includes(a),
                    o = "เลือกหัวข้อ" === l || t.subjects.includes(l),
                    h = "เลือกคอลเลคชัน" === q || t.collections.includes(q),
                    r = "เลือกผู้เขียน" === c || t.author.includes(c);
                return n && s && o && r && h
            })))
        }
