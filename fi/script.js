      ...
      if (t && t.length > 0) {
        ...
        function l() {
          ...
          n(
            t.filter((t) => {
              const n =
                  "Valitse Kieli" === e || t.languages.includes(e),
                s = "Valitse Vuosi" === a || t.year.includes(a),
                o = "Valitse Aihe" === l || t.subjects.includes(l),
                h =
                  "Valitse Kokoelma" === q ||
                  t.collections.includes(q),
                r = "Valitse Tekijä" === c || t.author.includes(c);
              return n && s && o && r && h;
            }),
          );
        }
