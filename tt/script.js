      ...
      if (t && t.length > 0) {
        ...
        function l() {
          ...
          n(
            t.filter((t) => {
              const n =
                  "Тел Сайла" === e || t.languages.includes(e),
                s = "Ел Сайла" === a || t.year.includes(a),
                o = "Тема Сайла" === l || t.subjects.includes(l),
                h =
                  "Коллекция Сайла" === q ||
                  t.collections.includes(q),
                r = "Автор Сайла" === c || t.author.includes(c);
              return n && s && o && r && h;
            }),
          );
        }
