    ...
    .then((t) => {
      if (t && t.length > 0) {
        ...
        function l() {
          ...
          n(
            t.filter((t) => {
              const n = "Виберіть Мову" === e || t.languages.includes(e),
                s = "Виберіть Рік" === a || t.year.includes(a),
                o = "Виберіть Тему" === l || t.subjects.includes(l),
                h = "Виберіть Колекцію" === q || t.collections.includes(q),
                r = "Виберіть Автора" === c || t.author.includes(c);
              return n && s && o && r && h;
            }),
          );
        }
