      ...
      if (t && t.length > 0) {
        ...
        function l() {
          ...
          n(
            t.filter((t) => {
              const n =
                  "Zimanê Hilbijêre" === e || t.languages.includes(e),
                s = "Salê Hilbijêre" === a || t.year.includes(a),
                o = "Mijarê Hilbijêre" === l || t.subjects.includes(l),
                h =
                  "Berhevokê Hilbijêre" === q ||
                  t.collections.includes(q),
                r = "Nivîskarê Hilbijêre" === c || t.author.includes(c);
              return n && s && o && r && h;
            }),
          );
        }
