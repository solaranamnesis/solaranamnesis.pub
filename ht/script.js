      ...
      if (t && t.length > 0) {
        ...
        function l() {
          ...
          n(
            t.filter((t) => {
              const n =
                  "Chwazi Lang" === e || t.languages.includes(e),
                s = "Chwazi Ane" === a || t.year.includes(a),
                o = "Chwazi Sijè" === l || t.subjects.includes(l),
                h =
                  "Chwazi Koleksyon" === q ||
                  t.collections.includes(q),
                r = "Chwazi Otè" === c || t.author.includes(c);
              return n && s && o && r && h;
            }),
          );
        }
