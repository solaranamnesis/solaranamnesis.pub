          ...
          n(
            t.filter((t) => {
              const n = "Seleccionar idioma" === e || t.languages.includes(e),
                s = "Seleccionar any" === a || t.year.includes(a),
                o = "Seleccionar tema" === l || t.subjects.includes(l),
                h = "Seleccionar Col·lecció" === q || t.collections.includes(q),
