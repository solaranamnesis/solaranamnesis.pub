      ...
      if (t && t.length > 0) {
        ...
        function l() {
          ...
          n(
            t.filter((t) => {
              const n =
                  "Khel Songokh" === e || t.languages.includes(e),
                s = "On Songokh" === a || t.year.includes(a),
                o = "Tem Songokh" === l || t.subjects.includes(l),
                h =
                  "Tsugluulga Songokh" === q ||
                  t.collections.includes(q),
                r = "Zokhiologch Songokh" === c || t.author.includes(c);
              return n && s && o && r && h;
            }),
          );
        }
