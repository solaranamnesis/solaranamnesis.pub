    ...
    .then((t) => {
      if (t && t.length > 0) {
        ...
        function l() {
          ...
          n(
            t.filter((t) => {
              const n = "ഭാഷ തിരഞ്ഞെടുക്കുക" === e || t.languages.includes(e),
                s = "വർഷം തിരഞ്ഞെടുക്കുക" === a || t.year.includes(a),
                o = "വിഷയം തിരഞ്ഞെടുക്കുക" === l || t.subjects.includes(l),
                h = "ശേഖരം തിരഞ്ഞെടുക്കുക" === q || t.collections.includes(q),
                r = "രചയിതാവ് തിരഞ്ഞെടുക്കുക" === c || t.author.includes(c);
              return n && s && o && r && h;
            }),
          );
        }
