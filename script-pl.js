function renderBooks() {
  ...
  e.innerHTML = "";
    fetch("books-pl.json").then((t => t.json())).then((t => {
     if (t && t.length > 0) {
    loadingIndicator.style.display = "none";
        ...
        function l() {
            ...
            n(t.filter((t => {
                const n = "Wybierz język" === e || t.languages.includes(e),
                    s = "Wybierz rok" === a || t.year.includes(a),
                    o = "Wybierz temat" === l || t.subjects.includes(l),
                    h = "Wybierz kolekcję" === q || t.collections.includes(q),
                    r = "Wybierz autora" === c || t.author.includes(c);
                return n && s && o && r && h
            })))
        }
