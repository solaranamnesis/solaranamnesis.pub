      ...
      if (t && t.length > 0) {
        ...
        function l() {
          ...
          n(
            t.filter((t) => {
              const n =
                  "Selectați Limba" === e || t.languages.includes(e),
                s = "Selectați Anul" === a || t.year.includes(a),
                o = "Selectați Subiectul" === l || t.subjects.includes(l),
                h =
                  "Selectați Colecția" === q ||
                  t.collections.includes(q),
                r = "Selectați Autorul" === c || t.author.includes(c);
              return n && s && o && r && h;
            }),
          );
        }
