    ...
    .then((t) => {
      if (t && t.length > 0) {
        ...
        function l() {
          ...
          n(
            t.filter((t) => {
              const n = "Pilih Basa" === e || t.languages.includes(e),
                s = "Pilih Taun" === a || t.year.includes(a),
                o = "Pilih Topik" === l || t.subjects.includes(l),
