      ...
      if (t && t.length > 0) {
        ...
        function l() {
          ...
          n(
            t.filter((t) => {
              const n =
                  "மொழியைத் தேர்ந்தெடுக்கவும்" === e || t.languages.includes(e),
                s = "ஆண்டைத் தேர்ந்தெடுக்கவும்" === a || t.year.includes(a),
                o =
                  "தலைப்பைத் தேர்ந்தெடுக்கவும்" === l || t.subjects.includes(l),
                h =
                  "தொகுப்பைத் தேர்ந்தெடுக்கவும்" === q ||
                  t.collections.includes(q),
                r =
                  "ஆசிரியரைத் தேர்ந்தெடுக்கவும்" === c || t.author.includes(c);
              return n && s && o && r && h;
            }),
          );
        }
