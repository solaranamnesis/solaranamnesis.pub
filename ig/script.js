    ...
    .then((t) => {
      if (t && t.length > 0) {
        ...
        function l() {
          ...
          n(
            t.filter((t) => {
              const n = "Họrọ Asụsụ" === e || t.languages.includes(e),
                s = "Họrọ Afọ" === a || t.year.includes(a),
                o = "Họrọ Isiokwu" === l || t.subjects.includes(l),
                h = "Họrọ Nchịkọta" === q || t.collections.includes(q),
                r = "Họrọ Onye Odee" === c || t.author.includes(c);
              return n && s && o && r && h;
            }),
          );
        }
