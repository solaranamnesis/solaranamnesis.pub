      ...
      if (t && t.length > 0) {
        ...
        function l() {
          ...
          n(
            t.filter((t) => {
              const n =
                  "Vybrat jazyk" === e || t.languages.includes(e),
                s = "Vybrat rok" === a || t.year.includes(a),
                o = "Vybrat téma" === l || t.subjects.includes(l),
                h =
                  "Vybrat sbírku" === q ||
                  t.collections.includes(q),
                r = "Vybrat autora" === c || t.author.includes(c);
              return n && s && o && r && h;
            }),
          );
        }
